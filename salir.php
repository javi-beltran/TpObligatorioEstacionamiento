...
<!-- class="form-signin" action="hacerlogin.php" method="post" -->
  ...
  <h1 class="display-4">Cocheras Javi S.A.</h1>
  <h5 class="display-4">Salida</h5>
  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
        <h4 class="my-0 font-weight-normal">Día</h4>
      </div>
      <div class="card-body">
    ...
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
        <h4 class="my-0 font-weight-normal">Mes</h4>
      </div>
      <div class="card-body">
    ...
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
        <h4 class="my-0 font-weight-normal">2 Meses</h4>
      </div>
      <div class="card-body">
